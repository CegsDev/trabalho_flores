...
Descritivo: Leitura de números até valor negativo
*******************************************************************************/
do {
    $numeroInformado = (int)readline("Digite um número: ");
    if ($numeroInformado >= 0) {
        echo "Você digitou: $numeroInformado\n";
    }
} while ($numeroInformado >= 0);

echo "Número negativo detectado. Encerrando o programa.\n";
?>
